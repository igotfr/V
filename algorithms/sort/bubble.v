...
fn bubble_sort_body_recursion<T>(mut array_to_sort []T, compare fn (a T, b T) bool) {
  array_to_sort_len := array_to_sort.len
  ...
  bubble_sort_body_recursion<T>(mut array_to_sort[0..array_to_sort_len - 1], compare)
}

fn bubble_sort_recursion_mutation<T>(mut array_to_sort []T, compare fn (a T, b T) bool) {
  bubble_sort_body_recursion<T>(mut array_to_sort, compare)
}

fn bubble_sort_recursion<T>(array_to_sort []T, compare fn (a T, b T) bool) []T {
  mut array_to_sort_clone := array_to_sort.clone()

  bubble_sort_body_recursion<T>(mut array_to_sort_clone, compare)
